...
<head>
    ...
    <title>Configurações | Econnect</title>
...
<body>
    ...
    <header>
        <div id="topHeader">
            ...
            <form enctype="multipart/form-data" action="database/controller.php?action=uploadUserPhoto" method="post" id="userPhotoForm">
                <input type="file" id="userPhoto" name="userPhotoPath">
                <button type="submit" id="submitForm">Enviar</button>
            </form>

            <label for="userPhoto" class="userPhotoContainer skeleton">
    ...
    <section id="bottomMenu">
        <nav>
            <ul>
                <div class="logo">
                    <img src="assets/favicon_io/logoEscrita.svg" alt=""></img>
                </div>
                <li>
    ...
    <main>
        ...
        <section id="settingsChangeContainer">
            <div class="themeContainer">
                <h3 class="skeleton">Tema</h3>
                <div class="changeThemeContainer">
                    <button class="theme dark skeleton" title="Tema escuro">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 32 32" fill="none" class="feather">
                        <path d="M27.9999 17.0533C27.7901 19.3229 26.9383 21.4859 25.5442 23.2891C24.15 25.0922 22.2712 26.4611 20.1275 27.2354C17.9838 28.0097 15.6638 28.1575 13.4392 27.6615C11.2146 27.1654 9.17719 26.0461 7.5655 24.4344C5.95381 22.8227 4.83445 20.7853 4.33841 18.5607C3.84237 16.336 3.99016 14.0161 4.76448 11.8724C5.53881 9.72868 6.90764 7.84982 8.71082 6.45567C10.514 5.06152 12.6769 4.20974 14.9465 4C13.6178 5.79769 12.9783 8.0126 13.1446 10.2419C13.3108 12.4712 14.2717 14.5667 15.8524 16.1475C17.4331 17.7282 19.5287 18.689 21.758 18.8553C23.9873 19.0215 26.2022 18.3821 27.9999 17.0533V17.0533Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="containerAccount">
                <div class="title">
                    <h3 class="skeleton">Conta</h3>
                    <button type="button" id="editDataButton" class="skeleton">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                        <path d="M12.8335 4.66602H4.66683C4.04799 4.66602 3.4545 4.91185 3.01691 5.34943C2.57933 5.78702 2.3335 6.38051 2.3335 6.99935V23.3327C2.3335 23.9515 2.57933 24.545 3.01691 24.9826C3.4545 25.4202 4.04799 25.666 4.66683 25.666H21.0002C21.619 25.666 22.2125 25.4202 22.6501 24.9826C23.0877 24.545 23.3335 23.9515 23.3335 23.3327V15.166" stroke="url(#paint0_linear_412_2011)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M21.5835 2.91628C22.0476 2.45215 22.6771 2.19141 23.3335 2.19141C23.9899 2.19141 24.6194 2.45215 25.0835 2.91628C25.5476 3.38041 25.8084 4.0099 25.8084 4.66628C25.8084 5.32266 25.5476 5.95215 25.0835 6.41628L14.0002 17.4996L9.3335 18.6663L10.5002 13.9996L21.5835 2.91628Z" stroke="url(#paint1_linear_412_2011)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <defs>
                        <linearGradient id="paint0_linear_412_2011" x1="8.8959" y1="-142.334" x2="53.2174" y2="-138.617" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#00E0FF"/>
                        <stop offset="1" stop-color="#0558BA"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear_412_2011" x1="14.4818" y1="-113.133" x2="49.2528" y2="-110.217" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#00E0FF"/>
                        <stop offset="1" stop-color="#0558BA"/>
                        </linearGradient>
                        </defs>
                ...
                <form method="POST" action="database/controller.php?action=update" id="formChangeDataAccont">
                    <div class="field">
                        <input value="<?php if(isset($userId)) {echo $user->Name_user;} ?>" disabled type="text" name="name" id="nome" class="input nome skeleton" required placeholder="Ex: Nome Sobrenome">
                        <label for="nome" class="skeleton">Nome</label>
                    </div>     
        
                    <div class="field">
                        <input value="<?php if(isset($userId)) {echo $user->Email_user;} ?>" disabled type="email" name="email" id="emailSignUp" class="input validation email skeleton" required placeholder="Ex: novoEmail002@gmail.com">
                        <label for="emailSignUp" class="skeleton">Email</label>
                    </div>
        
                    <div class="field">
                        <input value="<?php if(isset($userId)) {echo 12345678;} ?>" disabled type="password" name="password" id="passwordSignUp" class="input validation password skeleton" required placeholder="Ex: m*nhaS*nh*N*va0*2" minlength="8" maxlength="16">
                        <label for="passwordSignUp" class="skeleton">Senha</label>
                    </div>

                    <button disabled type="submit" id="editAccount" class="skeleton">
                        Alterar dados
                    </button>          
                </form>

                <div id="dangerOptions">
                    <div class="title">
                        <h3 class="skeleton">Zona de perigo</h3>
                    </div>

                    <div id="options">
                        <a href="database/controller.php?action=exitAccount" class="skeleton optionBtn">
                            <button type="submit" id="exitAccount">
                                Sair da conta
                            </button>
                        </a>
        
                        <a href="database/controller.php?action=delete" class="skeleton optionBtn">
                            <button type="button" id="logOut">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                    <path d="M9.375 21.875H5.20833C4.6558 21.875 4.12589 21.6555 3.73519 21.2648C3.34449 20.8741 3.125 20.3442 3.125 19.7917V5.20833C3.125 4.6558 3.34449 4.12589 3.73519 3.73519C4.12589 3.34449 4.6558 3.125 5.20833 3.125H9.375" stroke="#FF0000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M16.6665 17.7077L21.8748 12.4993L16.6665 7.29102" stroke="#FF0000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M21.875 12.5H9.375" stroke="#FF0000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                Apagar conta
                            </button>   
                        </a>
