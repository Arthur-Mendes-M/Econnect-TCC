...
<head>
    ...
    <title>Tela inical | Econnect</title>
    
    <meta name="description" content="Econnect - O sistema de busca por ecopontos, solicitação de retirada e denúncia de locais com acumulo de resíduo. ">
...
<body>
    ...
    <main>
        ...
        <section id="requestGarbageRemoval">
            <div class="title">
                <a href="#" aria-bot="retirada">
                    <h3 class="skeleton">Soliciar retirada do resíduo</h3>
                    <p class="skeleton">
                        Ver locais que realizam a retirada
                        <i class="fa-solid fa-angle-right skeleton"></i>                    
                    </p>
                </a>
            </div>
        ...
        <section id="searchPointsDisposal">
            <div class="title">
                <a href="#" aria-bot="action-alternatePage">
                    <h3 class="skeleton">Buscar por pontos de descarte</h3>
                    <p class="skeleton">
                        Ver locais que recebem o descarte
            ...
            <div class="mapouter">
                <div class="gmap_canvas skeleton" id="mapsHome">
                </div>
            </div> 

            <div class="cardsFilters" title="Use o mapa acima para ver o ecoponto mais próximo de você">
                <div class="card">
                    <div class="icon skeleton">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M1 6V22L8 18L16 22L23 18V2L16 6L8 2L1 6Z" stroke="url(#paint0_linear_393_1886)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M8 2V18" stroke="url(#paint1_linear_393_1886)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M16 6V22" stroke="url(#paint2_linear_393_1886)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <defs>
                            <linearGradient id="paint0_linear_393_1886" x1="12" y1="2" x2="12" y2="22" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#00D76E"/>
                            <stop offset="0.0001" stop-color="#00D76E"/>
                            <stop offset="1" stop-color="#1ABD00"/>
                            </linearGradient>
                            <linearGradient id="paint1_linear_393_1886" x1="8.5" y1="2" x2="8.5" y2="18" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#00D76E"/>
                            <stop offset="0.0001" stop-color="#00D76E"/>
                            <stop offset="1" stop-color="#1ABD00"/>
                            </linearGradient>
                            <linearGradient id="paint2_linear_393_1886" x1="16.5" y1="6" x2="16.5" y2="22" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#00D76E"/>
                            <stop offset="0.0001" stop-color="#00D76E"/>
                            <stop offset="1" stop-color="#1ABD00"/>
                            </linearGradient>
                    ...
                    <h5 class="skeleton">Distância</h5>
                </div>

                <div class="card" title="Entre em contato através do telefone cadastrado nos marcadores para saber o preço da retirada">
                    <div class="icon skeleton">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M12 1V23" stroke="url(#paint0_linear_393_1848)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M17 5H9.5C8.57174 5 7.6815 5.36875 7.02513 6.02513C6.36875 6.6815 6 7.57174 6 8.5C6 9.42826 6.36875 10.3185 7.02513 10.9749C7.6815 11.6313 8.57174 12 9.5 12H14.5C15.4283 12 16.3185 12.3687 16.9749 13.0251C17.6313 13.6815 18 14.5717 18 15.5C18 16.4283 17.6313 17.3185 16.9749 17.9749C16.3185 18.6313 15.4283 19 14.5 19H6" stroke="url(#paint1_linear_393_1848)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <defs>
                            <linearGradient id="paint0_linear_393_1848" x1="12.5" y1="1" x2="12.5" y2="23" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#00D76E"/>
                            <stop offset="0.0001" stop-color="#00D76E"/>
                            <stop offset="1" stop-color="#1ABD00"/>
                            </linearGradient>
                            <linearGradient id="paint1_linear_393_1848" x1="12" y1="5" x2="12" y2="19" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#00D76E"/>
                            <stop offset="0.0001" stop-color="#00D76E"/>
                            <stop offset="1" stop-color="#1ABD00"/>
                            </linearGradient>
                    ...
                    <h5 class="skeleton">Preço</h5>
                </div>

                <div class="card" title="Seg a Sex: 8h30 às 16h30 | Sábado: 8h30 às 11h30.">
                    <div class="icon skeleton">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="url(#paint0_linear_393_1851)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M12 6V12L16 14" stroke="url(#paint1_linear_393_1851)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <defs>
                            <linearGradient id="paint0_linear_393_1851" x1="12" y1="2" x2="12" y2="22" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#00D76E"/>
                            <stop offset="0.0001" stop-color="#00D76E"/>
                            <stop offset="1" stop-color="#1ABD00"/>
                            </linearGradient>
                            <linearGradient id="paint1_linear_393_1851" x1="14" y1="6" x2="14" y2="14" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#00D76E"/>
                            <stop offset="0.0001" stop-color="#00D76E"/>
                            <stop offset="1" stop-color="#1ABD00"/>
                            </linearGradient>
    ...
    <script src="https://kit.fontawesome.com/0e61fdb07c.js" crossorigin="anonymous"></script>

    <script src="assets/JS/mapsHome.js"></script>
